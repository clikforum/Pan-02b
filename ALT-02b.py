...
import smbus2 as smbus  # Import globale, usa smbus2 ma con nome smbus
SimulatedRun = False
try:
    #import smbus2
    print("Using smbus2")
...
def create_widgets():
    ...
    if logo_image != None:
        ...
        if logo_image:
            logo_label = tk.Label(top_left_area_frame, image=logo_image, bg="AntiqueWhite1")
